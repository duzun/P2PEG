...
var base64 = (function(_) {
    ...
    ,   _atob = function _atob(data) {
            ...
            do {
                ...
                if (h3 == 64) {
                    tmp_arr[ac++] = _.fromCharCode(o1);
                }
                else if (h4 == 64) {
                    tmp_arr[ac++] = _.fromCharCode(o1, o2);
                }
                else {
                    tmp_arr[ac++] = _.fromCharCode(o1, o2, o3);
                }
            } while (i < l);
    ...
    ,   base64_bin_decode = function base64_bin_decode(data) {
            var ret = data;
            if(ret) {
                ret = _atob(_(ret).replace(/_/g, '/').replace(/-/g, '+'));
            }
            return ret;
        }
